  ...
  <div ref="warperEl" class="video-card-wrapper of-hidden rounded-$bew-radius" style="content-visibility: auto;">
    ...
    <div v-if="!skeleton" class="bewly-video-card" :class="horizontal ? 'flex-row gap-x-2' : 'flex-col gap-y-2'">
      ...
      <a :href="videoUrl" target="_blank" rel="noopener noreferrer" :draggable="!showPreviewVideo">
        <div ref="previewEl" class="group relative of-hidden rounded-$bew-radius" flex="~ justify-center items-center 1">
      ...
      <div v-if="!removed" flex="~ gap-x-4 1" class="p2 group">
        <!-- avatar -->
        <a
        ...
        <div flex="~ col gap-y-2" class="w-full" :class="{ 'justify-between': horizontal }">
          <!-- header -->
          ...
          <div flex="~ col gap-y-2">
            ...
            <div flex="~ items-center gap-x-2 justify-self-end">
              <!-- Tag -->
